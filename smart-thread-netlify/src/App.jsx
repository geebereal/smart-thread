        ...
        {view !== "onboarding" && (
          <header className="fi" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24, paddingTop: 8, gap: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
              ...
              <span className="logo-text" style={{ fontFamily: "var(--ui)", fontWeight: 800, fontSize: 18, letterSpacing: "-0.4px" }}>Smart Thread</span>
            </div>
            <nav style={{ display: "flex", gap: 2, alignItems: "center", flexWrap: "nowrap" }}>
              {[
                ...
                { label: "Settings", short: "⚙", v: "settings", onClick: () => setView("settings") },
              ].map(tab => (
                <button key={tab.v} onClick={tab.onClick} style={{
                  ...
                  <span className="nav-short">{tab.short}</span>
