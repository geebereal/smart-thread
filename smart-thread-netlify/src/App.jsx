...
export default function SmartThread() {
  ...
  const currentPlan = PLANS[plan] || PLANS.seed;
        ...
        {view === "settings" && (
          <div className="fi">
            ...
            <div className="glass settings-section">
              <div style={{ fontSize: 13, fontWeight: 700, fontFamily: "var(--ui)", marginBottom: 4 }}>License Key</div>
            ...
            {plan === "seed" && (
              <div className="glass settings-section fid1">
                <div style={{ fontSize: 13, fontWeight: 700, fontFamily: "var(--ui)", marginBottom: 4 }}>How to upgrade</div>
                <p style={{ fontSize: 11, fontFamily: "var(--serif)", color: "var(--sub)", fontStyle: "italic", marginBottom: 14 }}>
            ...
            {plan !== "seed" && currentPlan.gumroadInstructions && (
              <div className="glass settings-section fid1" style={{ borderColor: currentPlan.border }}>
                <div style={{ fontSize: 13, fontWeight: 700, fontFamily: "var(--ui)", marginBottom: 4, color: currentPlan.color }}>
            ...
            <div className="glass settings-section fid2">
              <div style={{ fontSize: 13, fontWeight: 700, fontFamily: "var(--ui)", marginBottom: 4 }}>Email</div>
            ...
            <div style={{ textAlign: "center", marginTop: 24, paddingBottom: 20 }}>
              <div style={{ fontSize: 10, fontFamily: "var(--mono)", color: "var(--sub)", letterSpacing: 0.5 }}>
                Smart Thread v1.0 · {isCloud ? "☁ Cloud synced" : "💾 Local storage"} · Built with Claude
              </div>
            </div>
          </div>
        )}
